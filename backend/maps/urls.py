...
from .views import ClassroomListView, BuildingInfoListView, MenuListView, RestaurantViewSet, TagViewSet, FacilityInfoListView
...
urlpatterns = [
    ...
    path('facility', FacilityInfoListView.as_view(), name='facility-list'),
